...
#define MAVLINK_RATE_POSITION               1   // LOCAL_POSITION, GLOBAL_POSITION/GLOBAL_POSITION_INT messages. |
#define MAVLINK_RATE_RAW_SENSORS            100   // IMU_RAW, GPS_RAW, GPS_STATUS packets.
...
#define MAVLINK_FRAME_FREQUENCY             100
